...
class _NewLoginState extends State<NewLogin> {
  ...
  String resetPasswordUrl = "https://havenslearningcenter.xyz/password-reset/";
  ...
  final Uri _url = Uri.parse('https://havenslearningcenter.xyz/password-reset/');
                  ...
                  RawMaterialButton(
                    onPressed: () {
                      ...
                      if (_formKey.currentState!.validate()) {
                        if(username == ""){
                          loginController.loginUser(_usernameController.text.trim(), _passwordController.text.trim());
                        }
                        if(username != ""){
                          loginController.loginUser(username, _passwordController.text.trim());
                        }
